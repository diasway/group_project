...
Password Validation:
The setPassword(String password) method enforces that the password consists of 4-6 numeric characters only, throwing an IllegalArgumentException if the condition is not met.
